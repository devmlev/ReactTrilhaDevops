  ...
  return (
    <main className="download-page">
      <div className="download-page-content">
        <h1 className="download-title">Downloads Oficiais da Microsoft</h1>
        <p className="download-intro">Utilize os links abaixo para baixar as ferramentas necessárias diretamente dos servidores oficiais da Microsoft.</p>
